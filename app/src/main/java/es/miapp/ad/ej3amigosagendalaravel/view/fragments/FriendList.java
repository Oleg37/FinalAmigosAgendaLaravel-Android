...
import es.miapp.ad.ej3amigosagendalaravel.databinding.FragmentFriendListBinding;
...
import es.miapp.ad.ej3amigosagendalaravel.view.adapters.FriendAdapter;
...
public class FriendList extends Fragment implements InterfaceListenerFriend {
    ...
    private void init() {
        ...
        b.fabDeleteAll.setOnClickListener(v -> {
            if (!friendList.isEmpty()) {
                ...
                builder.setTitle("Eliminar todos los amigos").setMessage("¿Seguro que quieres eliminar toda tu " +
    ...
    public void onClickDelete(Friend friend) {
        ...
        builder.setPositiveButton("Aceptar", (dialog, id) -> viewModel.deleteFriend(friend.getId()));
